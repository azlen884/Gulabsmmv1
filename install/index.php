...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'test_db') {
        ...
        try {
            // First attempt: Connect directly to the specified database (standard on cPanel / shared hosts)
            $dsnWithDb = "mysql:host=$dbHost;port=$dbPort;dbname=$dbName;charset=utf8mb4";
            $pdo = new PDO($dsnWithDb, $dbUser, $dbPass, [
                PDO::ATTR_ERRMODE => PDO::ERRMODE_EXCEPTION,
                PDO::MYSQL_ATTR_MULTI_STATEMENTS => true
            ]);
            $message = "Database connection successful! Connected to database: $dbName.";
            $step = 2;
        } catch (Exception $eDirect) {
            // Second attempt: Connect without db and create it (for VPS / root / local dev)
            try {
                ...
                $error = "Database Connection Failed: " . $eDirect->getMessage();
            }
        }
        ...
        try {
            ...
            // Save persistent database configuration file
            $configContent = "<?php\n"
                . "/**\n"
                . " * RoseSMM Database Configuration (Generated by Installer)\n"
                . " */\n"
